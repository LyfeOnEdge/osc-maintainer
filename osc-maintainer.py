#! /usr/bin/python3
### Adapated from spinarak.py by CompuCat
...
def main():
	...
	underprint("osc-maintainer "+version+" by Lyfe, based on spinarak by CompuCat and the 4TU Team.")
	global config
